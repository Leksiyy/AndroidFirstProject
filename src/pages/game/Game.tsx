          ...
          : tileValue == 4 ? "#EEE1D0"
              : tileValue == 8 ? "#E8B486"
                  : tileValue == 16 ? "#E79B73"
                      : tileValue == 32 ? "#E4846E"
                          : tileValue == 64 ? "#E26A51"
                              : tileValue == 128 ? "#efcf6a"
                                  : tileValue == 256 ? "#efcf6a"
                                      : tileValue == 512 ? "#eed278"
                                          : tileValue == 1024 ? "#eecf6b"
                                              : tileValue == 2048 ? "#eecd5f"
                                                  : tileValue == 4096 ? "#3C3A34"
                                                      : tileValue == 8192 ? "#3C3A34"
                                                          : tileValue == 16384 ? "#3C3A34"
                                                              : tileValue == 32768 ? "#3C3A34"
                                                                  : "#";
}
          ...
          : tileValue == 4 ? "#766E66"
              : tileValue == 8 ? "#FAF3EF"
                  : tileValue == 16 ? "#FBF5F2"
                      : tileValue == 32 ? "#FBF5F2"
                          : tileValue == 64 ? "#FBF5F2"
                              : tileValue == 128 ? "#f9f7f3"
                                  : tileValue == 256 ? "#f9f7f3"
                                      : tileValue == 512 ? "#f9f7f3"
                                          : tileValue == 1024 ? "#f9f7f3"
                                              : tileValue == 2048 ? "#f9f7f3"
                                                  : tileValue == 4096 ? "#faf6ef"
                                                      : tileValue == 8192 ? "#faf6ef"
                                                          : tileValue == 16384 ? "#faf6ef"
                                                              : tileValue == 32768 ? "#faf6ef"
                                                                  : "#";
}
...
export default function Game() {
  ...
  const [tiles, setTiles] = useState([0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024 ,2048, 4096, 8192, 16384, 32768])
  ...
  return <View style={styles.container}>
    ...
    <TouchableWithoutFeedback
      ...
      <View style={[styles.field, {width: width * 0.95, height: width * 0.95}]}>
        {tiles.map((tile, index) => <Text key={index} style={[styles.tile, {
